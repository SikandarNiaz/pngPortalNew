  ...
  ngOnInit() {
    this.router.events
      ...
      .subscribe((e: NavigationEnd) => {
        ...
        if (
          e.url == "/dashboard/sos-dashboard" ||
          e.url == "/dashboard/sku-dashboard" ||
          e.url == "/dashboard/productivity-tableau" ||
          e.url == "/dashboard/stf-dashboard"
        ) {
    ...
    if (t || r || localStorage.getItem("user_type") == null) {
      this.hideSideBar = true;
    }
  }
